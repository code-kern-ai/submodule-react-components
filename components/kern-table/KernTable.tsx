    ...
    switch (cell.type) {
        case 'Component':
            switch (cell.component) {
                ...
                case 'ETLTaskStateCell':
                    return <ETLTaskStateCell {...cell} />;
                case '@provided@':
